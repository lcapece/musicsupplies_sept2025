...
-- 1. First, create the logon_lcmd table if it doesn't exist
...
-- 4. Create policy for authenticated access
...
-- 5. Update accounts_lcmd table to include necessary fields if not present
...
-- 6. Update account 101 with correct data
...
-- 7. Insert the known password for account 101 into logon_lcmd
...
-- 8. Create or replace the authentication function
...
-- 9. Create function to update password in logon_lcmd
