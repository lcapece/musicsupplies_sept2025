/*
  ...
  1. Directly checks the password in accounts_lcmd table
  2. Handles case-insensitive comparison for default passwords
  3. Ensures account 101 can log in with "A11803" (case-insensitive)
*/

-- Drop existing authenticate functions to avoid conflicts
...
-- Create a new, simplified authentication function
...
BEGIN
  ...
  RAISE NOTICE 'Checking account %: name=%, zip=%', 
    p_account_number, account_record.acct_name, account_record.zip;
