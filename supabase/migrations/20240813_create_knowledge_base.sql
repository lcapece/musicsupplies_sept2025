...
CREATE INDEX idx_knowledge_keywords ON chat_knowledge_base USING GIN(keywords);
CREATE INDEX idx_knowledge_category ON chat_knowledge_base(category);
CREATE INDEX idx_knowledge_active ON chat_knowledge_base(is_active);
