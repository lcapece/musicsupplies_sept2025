/*
  # Update authentication function for account 99
  
  This migration updates the authenticate_user_lcmd function to handle account 99 specially,
  which will redirect to a special admin screen for SKU imports.
*/

-- Drop the existing function
DROP FUNCTION IF EXISTS authenticate_user_lcmd(text, text);

-- Create the updated function with account 99 special handling
